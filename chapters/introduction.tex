...
%
\begin{figure}[tb]\centering
  \includegraphics[width=\linewidth]{cerenk_atomi_bogo_new}
  \caption{
    % 
    Bla bla yata yata. From Ref.~\cite{Carusotto_2006}.
    % 
...
\paragraph{Landau causality rule}%TODO: incorporate
...
way to achieve this in practice is by adding an infinitesimally small
positive imaginary part to the frequency $[\dots]$

\section{Cherenkov emission}
\label{sec:cherenkov}
