...
Investigations along these lines are presently very active in Trento
...
Therefore, as a starting point of my work in Trento, I will focus on
the implications of \cite{2014arXiv1403.6041P} for linear optical
systems. On one hand, I will consider systems of microcavity
polaritons on which I have acquired a good expertise in the last years
and for which the Trento group is involved in several experimental
collaborations.  On the other hand, I will try to extend these ideas
to novel optical systems such as arrays of Si-based coupled ring
resonators for which there is an active experimental interest in
Trento. With a proper design of the resonator array \cite{Hafezi2013},
this latter system has been demonstrated to be accurately described by
the HH model with a strong and uniform artificial gauge field piercing
the lattice. As a further addition, the harmonic trapping potential,
which plays the role of kinetic energy in momentum space, can easily
be implemented as a modulation of the resonator size.  In a second
phase of my stay in Trento I will start investigating how the
topological concepts are affected by the optical nonlinearities.

I propose a 6 month stay in Trento, from December to May 2015, which
should allow for learning the new analytical and numerical techniques
necessary for the succesfull completion of this project, which will
also conclude my doctoral thesis. In addition, I will be able to
interact with the stimulating scientific environment at the BEC Center
and enjoy the excellent supervision of Iacopo Carusotto, an expert in
the field of photonic quantum fluids \cite{Carusotto2013}. Also,
during my stay I plan to actively take part in the scientific
activities of the BEC Center, such as the weekly seminars.

As the proposed work is at the interface between ultracold atom and
polariton physics and aims at transferring ideas from one field to
another, I feel that it perfectly matches the scope and the goal of
the POLATOM network.
