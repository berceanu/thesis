...
\begin{figure}[tb]\centering
  ...
  \caption{
    ...
    anticrossing form characteristic of Hermitian coupling.  From
    Ref.~\cite{Keeling_2007}.
    % 
...
%
\begin{figure}[tb]\centering
  \includegraphics[width=\linewidth]{swing}
  \caption{
    % 
...
to the simply-connected geometry. The vortex was visible in both the
signal and idler state, and its lifetime was much longer than the
average polariton lifetime.  In a similar direction,
