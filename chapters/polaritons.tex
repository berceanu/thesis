...
\begin{figure}[tb]\centering
  \includegraphics[width=\linewidth]{cavity}
  \caption{
    % 
...
As mentioned in Sec.~\ref{sec:model-sys}, we are interested in an
...
%
\begin{figure}[tb]\centering
  % ~/notebooks/OPODrag/up_lp_disp.py
  \includegraphics[width=.8\linewidth]{fig_up_lp}
  \caption{
    % 
...
%
\begin{figure}[tb]\centering
  \includegraphics[width=\linewidth]{fig_bistable}
  % ~/notebooks/OPODrag/opoplots.py
  \caption{
    % 
...
%
\begin{figure}[tb]\centering
  \includegraphics[width=.7\linewidth]{swing}
  \caption{
    % 
...
\begin{figure}[tb]\centering
  % ~/notebooks/OPODrag/opoplots.py
  \includegraphics[width=.8\linewidth]{fig_satellites_ks_0_000}
  \caption{
    % 
...
\begin{figure}[tb]\centering
  % ~/notebooks/OPODrag/opoplots.py
  \includegraphics[width=.8\linewidth]{fig_response_sp_ks_0_000}
  \caption{
    % 
...
\begin{figure}[tb]\centering
  % ~/notebooks/OPODrag/opoplots.py
  \includegraphics[width=\linewidth]{fig_response_ev_ks_0_000}
  \caption{
    % 
...
\begin{figure}[p] % <--- only p
  \centering
    \includegraphics[width=\linewidth]{marchetti_threshold_comp}
    \includegraphics[width=\linewidth]{marchetti_spectrum_comp_review}
    \includegraphics[width=\linewidth]{marchetti_comp_OPO_figure_review_clean}
  \caption{
    %
...
\paragraph{OPO superfluidity}
%
\begin{figure}[H]\centering
  \includegraphics[width=\linewidth]{sanvitto_metastable_vortex}
  \caption{
    % 
