...
%
\begin{figure}[tb]\centering
  \includegraphics[width=.6\linewidth]{marchetti_threshold_comp}
  \includegraphics[width=.6\linewidth]{marchetti_spectrum_comp_review}
  \includegraphics[width=.6\linewidth]{marchetti_comp_OPO_figure_review_clean}
  \caption{
    %
...
%
\begin{figure}[tb]\centering
  \includegraphics[width=.6\linewidth]{sanvitto_metastable_vortex}
  \caption{
    % 
