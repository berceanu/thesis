...
\begin{figure}[tb]\centering
  ...
  \includegraphics[width=\linewidth]{fig_up_lp}
  \caption{
    % 
    ...
    $\delta = 0.3$ meV, $k_z = 20\, \mu m^{-1}$ and $\Omega_R = 2.5$ meV.
    %
...
\begin{figure}[tb]\centering
  ...
  \includegraphics[width=\linewidth]{fig_satellites_ks_0_000}
  \caption{
    % 
...
\begin{figure}[tb]\centering
  % ~/notebooks/OPODrag/opoplots.py
  \includegraphics[width=\linewidth]{fig_response_sp_ks_0_000}
  \caption{
    % 
