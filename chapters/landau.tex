...
\begin{figure}[p] \centering
  \includegraphics[width=\linewidth]{fringe_trap}
  % anc/scripts/torus_edge_fig.jl
  \caption{Momentum space reconstruction of the eigenstates in the
...
\afterpage{\clearpage}
\begin{figure}[p] \centering
  \includegraphics[width=\linewidth]{exp_fig}
  % anc/scripts/experimental_fig.jl
  \caption{\emph{Top row}: Intensity spectrum for a lattice of
    ...
    $k_x^0 = 0$ line in the MBZ (solid black line), 
    analytical prediction of Eq.~\eqref{eq:chi} 
